...
hyp_param={'debug':False,
           ...
           'target_col':'label',
           'seed':42,
           'model_name':'resnet18', #resnet18, resnet34, resnet50, resnext50, se_resnext50
           }
...
if hyp_param['location'].lower()=='flyai':
    csv_path='/home/dataset/cifar100/train.csv'
    img_path='/home/dataset/cifar100/train_images'
else:
    csv_path='./train.csv'
...
def get_transforms(mode):
    if mode == 'train':
        return albumentations.Compose([
            ...
            albumentations.CoarseDropout (max_holes=20, max_height=2, max_width=2, min_holes=None, min_height=None, min_width=None, fill_value=0, mask_fill_value=None, always_apply=False, p=0.5),
